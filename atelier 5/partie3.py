class Utilisateur: #declaration de classes 
    ...
    def __init__(self, nom="", email="", mot_de_passe="", genre="", age=0): #constructeur parametrique  
        self._nom = nom
        self._email = email
...
class Module:
    ...
    __semestre = ""
    ListMatiere = []
    def __init__(self, nom="", volume_horaire=0, semestre=""):#constructeur parametrique 
        self.__nom = nom
...
class Professeur(Utilisateur): # l heritage
    ...
    def __init__(self, nom="", email="", mot_de_passe="", genre="", age=0, ppr=0, grade=""): #l heritage a partire  classes de parent
...
class Etudiant(Utilisateur): #l heritage 
